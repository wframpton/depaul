...
public class Students implements Serializable {
    ...
    public void updateGpa(){
        ...
        try (Connection con = DbConnection.getConnection()){
            ...
            if (rs.next()){
                ...
                if(!Objects.equals(rs.getDouble(4), this.gpa)){
    ...
    public Double calcAvgGpa() throws ClassNotFoundException {
        ...
        try{
            Connection con = DriverManager.getConnection("jdbc:hsqldb:hsql://localhost/xdb","SA","SA");
            Statement stmt = con.createStatement();
        ...
        return Double.parseDouble(df.format(results));
    }
